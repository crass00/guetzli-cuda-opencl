...
ifeq ($(config),release)
  ...
  ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -O3 -g -fsigned-char `pkg-config --cflags libpng || libpng-config --cflags`
  ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -O3 -g -std=c++11 -fsigned-char `pkg-config --cflags libpng || libpng-config --cflags`
  ALL_RESFLAGS += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  LIBS +=
  LDDEPS +=
  ALL_LDFLAGS += $(LDFLAGS) -fsigned-char `pkg-config --libs libpng || libpng-config --ldflags`
...
ifeq ($(config),debug)
  ...
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
  ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -g -fsigned-char `pkg-config --cflags libpng || libpng-config --cflags`
  ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -g -std=c++11 -fsigned-char `pkg-config --cflags libpng || libpng-config --cflags`
  ALL_RESFLAGS += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  LIBS +=
  LDDEPS +=
  ALL_LDFLAGS += $(LDFLAGS) -fsigned-char `pkg-config --libs libpng || libpng-config --ldflags`
